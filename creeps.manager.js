...
var creepsManager = {
    ...
    run: function(roomName)
    {
        ...
        for (var spawnNum in spawns) {
	        ...
	        var upgraders2 = _.filter(Game.creeps, (creep) => creep.memory.role == 'upgrader2' && creep.memory.home == roomName);
	        ...
	        var attackers = _.filter(Game.creeps, (creep) => creep.memory.role == 'attackers' && creep.memory.home == roomName);
	        var claimers = _.filter(Game.creeps, (creep) => creep.memory.role == 'claimer' && creep.memory.home == roomName);
	        var reserve = _.filter(Game.creeps, (creep) => creep.memory.role == 'reserve' && creep.memory.home == roomName);
	        var reserve2 = _.filter(Game.creeps, (creep) => creep.memory.role == 'reserve2' && creep.memory.home == roomName);
	        var reserve3 = _.filter(Game.creeps, (creep) => creep.memory.role == 'reserve3' && creep.memory.home == roomName);
	        ...
	        var spawn = spawns[spawnNum].name;
	        //console.log(spawn);
	       ...
	       // console.log(roomName + "  " + repairers3.length + "-" + roomsManager.getBuildCount(roomName, 'repairer3') + "  " + roomsManager.getBuildString(roomName, 'upgrader'));
	        ...
	        //guard
	        } else if (roleDefender.enemiesInRoom(roomName) && guards.length < roomsManager.getBuildCount(roomName, 'guard')) {
	        ...
	        //reserve
	        } else if(reserve.length < roomsManager.getBuildCount(roomName, 'reserve')) {
	            var newName = Game.spawns[spawn].createCreep(roomsManager.getBuildString(roomName, 'reserve'), undefined, 
	            		roomsManager.getMemorySettings(roomName, 'reserve'));
	            var jobTitle = "reserve";
	
	     
	        //reserve2
	        } else if(reserve2.length < roomsManager.getBuildCount(roomName, 'reserve2')) {
	            var newName = Game.spawns[spawn].createCreep(roomsManager.getBuildString(roomName, 'reserve2'), undefined, 
	            		roomsManager.getMemorySettings(roomName, 'reserve2'));
	            var jobTitle = "reserve2";
	
	            
	        //reserve3
	        } else if(reserve3.length < roomsManager.getBuildCount(roomName, 'reserve3')) {
	            var newName = Game.spawns[spawn].createCreep(roomsManager.getBuildString(roomName, 'reserve3'), undefined, 
	            		roomsManager.getMemorySettings(roomName, 'reserve3'));
	            var jobTitle = "reserve3";
	        ...
	        //upgrader2
	        } else if (upgraders2.length < roomsManager.getBuildCount(roomName, 'upgrader2')) {
	            var newName = Game.spawns[spawn].createCreep(roomsManager.getBuildString(roomName, 'upgrader2'), undefined, 
	            		roomsManager.getMemorySettings(roomName, 'upgrader2'));
	            var jobTitle = "upgrader2";
	        ...
	        //remoteStorage        
	        } else if (remoteStorage.length < roomsManager.getBuildCount(roomName, 'remoteStorage') && storageStructures.length > 0 && !roomsManager.enemiesInRoom(roomsManager.getRemoteRoom(roomName, 'remoteStorage'))) {
	    ...
	    //            if (newName != -6 && newName != -4) { console.log('Spawning new newUpgrader in room ' + roomName + ': ' + newName); }
	        ...
	        //repairer2        
	        } else if (repairers2.length < roomsManager.getBuildCount(roomName, 'repairer2') && !roomsManager.enemiesInRoom(roomsManager.getRemoteRoom(roomName, 'repairer2')))  {
	        ...
	        //repairer3
	        } else if (repairers3.length < roomsManager.getBuildCount(roomName, 'repairer3') && !roomsManager.enemiesInRoom(roomsManager.getRemoteRoom(roomName, 'repairer3'))) {
	        ...
	        //remoteHarvester
	        } else if (remoteHarvesters.length < roomsManager.getBuildCount(roomName, 'remoteHarvester') && !roomsManager.enemiesInRoom(roomsManager.getRemoteRoom(roomName, 'remoteHarvester'))) {
	            ...
	            //console.log(roomsManager.getBuildString(roomName, 'remoteHarvester') + "   " + roomsManager.getMemorySettings(roomName, 'remoteHarvester') );
	 
	           
	        //remoteHarvester2
	        } else if (remoteHarvesters2.length < roomsManager.getBuildCount(roomName, 'remoteHarvester2') && !roomsManager.enemiesInRoom(roomsManager.getRemoteRoom(roomName, 'remoteHarvester2'))) {
	        ...
	        //remoteHarvester3
	        } else if (remoteHarvesters3.length < roomsManager.getBuildCount(roomName, 'remoteHarvester3') && !roomsManager.enemiesInRoom(roomsManager.getRemoteRoom(roomName, 'remoteHarvester3'))) {
	        ...
	        //remoteUpgrader
	        } else if (remoteUpgraders.length < roomsManager.getBuildCount(roomName, 'remoteUpgrader') && !roomsManager.enemiesInRoom(roomsManager.getRemoteRoom(roomName, 'remoteUpgrader'))) {
	        ...
	        //builder2
	        		...
	        		&& !roomsManager.enemiesInRoom(roomsManager.getRemoteRoom(roomName, 'builder2')) ) {
	        ...
	        //builder3
	        		...
	        		&& !roomsManager.enemiesInRoom(roomsManager.getRemoteRoom(roomName, 'builder3'))) {      //} )) {
	        ...
	        if (newName != -6 && newName != -4 && newName != undefined && newName != null) { 
